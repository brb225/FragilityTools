...
- id: baer2021samplesize
  ...
  - family: Wells
    given: Martin T.
  container-title: Under review at Journal of Clinical Epidemiology
  issued:
  - year: 2021
...
- id: baer2021incidence
  ...
  - family: Wells
    given: Martin T.
  container-title: Under review at P.N.A.S.
  issued:
  - year: 2021
  type: article-journal
- id: baer2021ltfu
  ...
  - year: 2021
  type: article-journal
- id: baer2021generalized
  title: 'A generalized development of the fragility index'
  author:
  - family: Baer
    given: Benjamin R.
  - family: Gaudino
  ...
  - family: Wells
    given: Martin T.
  container-title: To be submitted.
  issued:
  - year: 2021
  type: article-journal
---
...
The goal of FragilityTools is to provide a toolbox for researchers interested in the fragility index. The toolbox covers methodologies developed across four articles [@baer2021samplesize; @baer2021incidence; @baer2021ltfu; @baer2021generalized].
...
The LTFU-aware fragility index examples in @baer2021generalized can be reproduced using the code in `FragilityTools/exec/`. The file `/generalizedfi_examples.R` is a script which provides all the output that appears in the article. 
